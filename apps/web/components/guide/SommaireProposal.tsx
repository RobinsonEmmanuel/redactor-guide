    ...
    <div className="h-full flex flex-col bg-gray-50 border border-gray-200 rounded-lg overflow-hidden">
      ...
      <div className="p-4 border-b border-gray-200 bg-white">
        ...
        <button
          ...
          disabled={loading}
          className="w-full mt-3 flex items-center justify-center gap-2 px-4 py-2.5 bg-orange-500 text-white rounded-lg hover:bg-orange-500/60 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
        >
